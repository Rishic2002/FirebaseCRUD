...
class _ListViewProductState extends State<ListViewProduct> {
  ...
  void initState() {
    ...
    _onProductAddedSubscription =
        productReference.onChildAdded.listen(_onProductAdded) as StreamSubscription<Event>;
    _onProductChangedSubscription =
        productReference.onChildChanged.listen(_onProductUpdate) as StreamSubscription<Event>;
  }
